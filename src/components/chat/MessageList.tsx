                      ...
                      {message.parts.map((part, partIndex) => {
                        switch (part.type) {
                          ...
                          case "tool-invocation":
                            ...
                            const commandLabel = command === "create" ? "create" : command === "str_replace" || command === "insert" ? "edit" : command === "delete" ? "delete" : command === "rename" ? "rename" : null;
                            const label = fileName && commandLabel ? `${commandLabel} ${fileName}` : fileName ?? tool.toolName;
                            return (
